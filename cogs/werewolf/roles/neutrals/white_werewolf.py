...
class WhiteWerewolf(Role):
    metadata = RoleMetadata(
        ...
        card_image_url="https://file.garden/aTXEm7Ax-DfpgxEV/B%C3%AAn%20Hi%C3%A8n%20Nh%C3%A0%20-%20Discord%20Server/werewolf-game/role-pics/werewolf/white-wolf.png",
        tags=("self_target",),
    )
